...
The constellation and orrery direction should stay inside the original Melodia language, not replace it. The intended read is premium fantasy artbook plus professional technical documentation: vintage fashion editorial pacing, HoYoverse-level celestial craft, generous whitespace, gold rules, and clear recruiter scanning.
...
- The four environment pillars should continue to read as editorial chapters: Sakura Dream, Space Cathedral, Baroque Castle, and Bioluminescent Grotto.
- Escher logic should be framed as spatial design intelligence: tessellation, topology, recursion, patterning, and perspective clarity.
