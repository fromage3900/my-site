...
The current shared build is **20260921p1**. Canonical pages carry
`<meta name="melodia-build" content="20260921p1">` and cache-bust local CSS/JS with the
same version.
...
- **Source:** `index.html?embed=wix&v=20260921p1`
